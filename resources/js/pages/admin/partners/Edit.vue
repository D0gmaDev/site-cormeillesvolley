...
const submit = () => {
    form.put(`/admin/partenaires/${props.partner.id}`);
};
...
<template>
    <AdminLayout :title="`Éditer ${partner.name}`">
        <div class="space-y-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-3xl font-bold uppercase tracking-tight text-raisin">Éditer {{ partner.name }}</h1>
            </div>
            ...
            <form @submit.prevent="submit" class="max-w-xl rounded-lg bg-white p-6 shadow">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mb-2 flex h-24 items-center justify-center bg-gray-50">
